...
> 状态：已实施（2026-09-23；用户裁决三条 + 默认裁决否决窗口；对抗审查 A/B 两路处置见 §7；
> 四门全绿：typecheck / oxlint 0-0 / build / vitest 2330 用例；覆盖率 sandbox 包
> 96.37/93/94.23/98.74，全局 90.72/85.94/91.56/92.79）
