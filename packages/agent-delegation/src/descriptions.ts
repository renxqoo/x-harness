// 工具 description 逐字常量（docs/AGENT-DELEGATION.md §1.1）：取自 Claude Code 子代理与
// 后台任务工具文档的英文原文（源 /Users/wrr/work/claude-tool/agent-and-background-tasks.md）。
// 映射：agent_spawn←Agent、agent_message←SendMessage、agent_output←TaskOutput、
// agent_stop←TaskStop、list_agents←ListAgents。改动只能整体重同步源文档，禁止就地润色。
